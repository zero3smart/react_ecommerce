...
def load_wtop_svg_fixed(svg_fn, vertical, remove_all):
    id_fixups = {
        ...
        'sleeve_thumbnails_0' : 'sleeve_length_thumbnails_0',
        'sleeve_thumbnails_1' : 'sleeve_length_thumbnails_1',
        'sleeve_thumbnails_2' : 'sleeve_length_thumbnails_2',
        'sleeve_thumbnails_3' : 'sleeve_length_thumbnails_3',
        'sleeve_thumbnails_4' : 'sleeve_length_thumbnails_4',
        'sleeve_thumbnails_5' : 'sleeve_length_thumbnails_5',
